...
$(document).ready(function(){
    ...
    $("#frmRegistro").validate({
    	...
    	messages: 
        {
            ...
            'correo':{required: "<span class='error1'>Ingresa tu email</span>", email: "<span class='error1'>Por favor, indica una dirección de email válida</span>"},
            'clave': "<span class='error1'>Ingresa tu password supersecreta</span>",
            'tipo': "<span class='error1'>Ingresa tu tipo</span>",
    	...
    	submitHandler: function(form){
            ...
            envio.append("correo", $("#correo").val()); //usuario
            envio.append("clave", $("#clave").val());
            envio.append("nombre", $("#nombre").val());
            envio.append("tipo", $("input[name=tipo]:checked").val());//$("#tipo").val());
            envio.append("idPERFIL", $("#idPERFIL").val());
